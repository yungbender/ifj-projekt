...
if [ ! -e ifj2018 ]; then
    echo -e "${RED}Compiler wasn't found. Have you tried using 'make' first?${NOCOLOR}"
    exit 1
fi

if [ ! -e ic18int ]; then
    echo -e "${RED}Interpreter wasn't found. Download it and put it into base folder.${NOCOLOR}"
    exit 1
fi
